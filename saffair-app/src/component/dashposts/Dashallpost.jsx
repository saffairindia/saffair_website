...
export default function DashallPosts() {
        ...
        const fetchPosts = async () => {
            try {
                const res = await fetch(
                    `${process.env.REACT_APP_BACKEND_API}/api/getposts`
                );
    ...
    const handleShowMore = async () => {
        ...
        try {
            const res = await fetch(
                `${process.env.REACT_APP_BACKEND_API}/api/getposts?startIndex=${startIndex}`
            );
            const data = await res.json();
            if (res.ok) {
    ...
    return (
        <div className="table-auto p-3 mx-auto overflow-x-scroll md:overflow-x-auto scrollbar scrollbar-track-slate-100 scrollbar-thumb-slate-300 dark:scrollbar-track-slate-700 dark:scrollbar-thumb-slate-500">
