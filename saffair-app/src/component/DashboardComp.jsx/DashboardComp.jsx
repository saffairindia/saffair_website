    ...
    const fetchComments = async () => {
      try {
        const res = await fetch(
          `${process.env.REACT_APP_BACKEND_API}/api/comment/getcomments?limit=5`,
          {
            credentials: "include",
          }
        );
  ...
  return (
    <div className="p-3 md:mx-auto">
      <div className="flex-col md:flex-row flex gap-10 justify-center">
        ...
        <div className="flex flex-col justify-between p-5 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
          <div className="flex justify-between">
            <div className="">
